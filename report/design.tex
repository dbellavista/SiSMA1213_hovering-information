...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Person & AccessInformation, FindInformation, InputInformation, Step,
			Sense, Think. \\
			\hline
			Mobile node & ManageDevice, ShowInformation.  \\
			\hline
...
% TODO: What to do with Think-Sense-Step?
\begin{table}[H]
	\centering
	\begin{tabular}{|p{4cm}|p{8cm}|}
			\hline
			...
			\hline
			User Artifact & FindInformation, AccessInformation, InputInformation. \\
			\hline
