...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
      Access Hovering Information & Access the hovering information that is
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			MobileNode & ObtainPosition Use, DiscoverNeighbour Use, ShowInfo Use,
