...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			NodeIfDep & User Access Interaction, User List Interaction, User Create
			Interaction. \\
			\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Replicate & HoverInf Resource Interaction, Replication Interaction. \\
			\hline
			Jump & HoverInf Resource Interaction, Jump Interaction. \\
			\hline
			ManageDevice & HoverInf Resource Interaction. \\
			\hline
			...
			\hline
			CreateViaUI & User Access Interaction. \\
			\hline
			AccessViaUI & User Create Interaction. \\
			\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Jump Interaction & Movement Duplicate Rule, Movement Storage Rule. \\
			\hline
			Replication Interaction & Movement Duplicate Rule, Movement Storage Rule. \\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Node Resource Interaction & ShowInfo Interaction, ShowList Interaction. \\
			\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			information. \\
			\hline
			Storage Interaction & Access to storage resources. \\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			DiscoveNeighbour & LowLevel Access Interaction, LowLevel List
			Interaction, LowLevel Create Interaction.  \\
			\hline
			ManageStorage & Storage Interaction. \\
			\hline
			+ListInformation & LowLevel List Interaction, List UI Interaction. \\
			\hline
			+CreateInformation & LowLevel Create Interaction.  \\
			\hline
			+AccessInformation & LowLevel Access Interaction. Access UI Interaction. \\
			\hline
			ShowInformation & ShowInfo Interaction, ShowList Interaction. \\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Mobile node & StorageArtifact, Positioning Artifact, MobileUI Artifact,
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			Communication Artifact & Communicate, DiscoveNeighbour. \\
			\hline
			Storage Artifact & InsertData, RemoveData, GetRemainingSpace, GetMaximumSize. \\
			\hline
			Positioning Artifact & ObtainPosition. \\
			\hline
			MobileUI Artifact & ShowInformation, ShowInformationList, InputInformation. \\
			...
			\hline
			SimulatorInquisitor Artifact & InquireNodes, InquireHovering, InquireEnvironment \\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Mobile Device Artifact & Storage Artifact, Positioning Artifact, MobileUI
			Artifact, Communication Artifact. \\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Mobile Device Artifact & Mobile Node. \\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Vital  Space & Person's vital space.\\
			\hline
		\end{tabular}
