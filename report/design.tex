...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			information operation. \\
			\hline
			Create UI Interaction & User can insert the information required in order
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Hovering Artifact & Replicate, Jump. \\
			\hline
			Legs Artifact & MoveAction. \\
			\hline
			NodeUser Artifact & UserAccessInformation, UserCreateInformation. \\
			\hline
			...
			\hline
			MobileUI Artifact & ShowInformation, ShowInformationList, InputInformation. \\
			\hline
