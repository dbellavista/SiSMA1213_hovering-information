...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			manage\_communication & Communication Range.\\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{5cm}|p{7cm}|}
			...
			\hline
			access\_information & CreateInfDepm, SimStartedDep, SimDataDep.\\
			\hline
			create\_information & CreateInfDep, SimStartedDep, SimDataDep. \\
			\hline
			manage\_storage & NodeResDep, SimDataDep. \\
			\hline
			analyze\_simulation & SimStartedDep, SimDataDep.\\
			\hline
