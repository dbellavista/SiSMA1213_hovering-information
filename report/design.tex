...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
			Manage Device & get\_position, discover\_neighbours, manage\_storage \\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			GetMaximumSize, DiscoveNeighbour, ObtainPosition. \\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			GetRemainingSpace, GetMaximumSize, ObtainPosition. \\
			\hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4cm}|p{8cm}|}
			...
			\hline
      MobileNode & ObtainPosition Use, DiscoverNeighbour Use,
